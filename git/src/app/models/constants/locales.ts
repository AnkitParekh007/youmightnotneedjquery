export const LocaleData = [
	...
	{
		id: "nb-SJ",
		name: "Norwegian Bokm̴l - Svalbard and Jan Mayen Islands",
		country: "SJM",
		language: "nb",
		numbers: {
			decimal: ",",
