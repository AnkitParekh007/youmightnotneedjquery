...
export class PermissionsConfigurationService {
	...
	constructor(@Inject(USE_CONFIGURATION_STORE) private isolate: boolean = false, private configurationStore: PermissionsConfigurationStore) {
	...
	private isPredefinedStrategy(strategy: string): boolean {
		return strategy === PermissionsPredefinedStrategies.SHOW || strategy === PermissionsPredefinedStrategies.REMOVE;
	}
}
